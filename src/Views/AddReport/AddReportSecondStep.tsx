    ...
    function handleEmailChange(event: ChangeEvent<HTMLInputElement>) {
        ...
        function submitForm(event: { preventDefault: () => void; }) {
            ...
            const newReport: ReportData = {
                ...
                address: address,
                guestEmail: guestEmail.trim() !== "" ? guestEmail : undefined,
                photos: photos
            }
                        ...
                        <div className="report-form-wrapper">
                            <div className="report-form-first-col">
                                ...
                                <div className="report-form-group">
                                    ...
                                    <select value={categoryId} onChange={handleCategoryChange} name="category" className="report-form-input">
                                        {categories.map( c => (
                            ...
                            <div className="report-form-second-col">
                                <div className="report-form-group">
                                    ...
                                    <div className="report-form-minimap">
                                        ...
                                        <MapContainer center={[51.7592, 19.4558]} zoom={13}
                                ...
                                <div className="report-form-group">
                                    <label className="report-form-label" htmlFor="guestEmail">Adres e-mail (opcjonalnie)</label>
                                    <input
                                        type="email"
